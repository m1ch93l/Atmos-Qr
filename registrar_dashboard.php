...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                        <a class="dropdown-item" id="profileDropdown" href="#" role="button" data-toggle="modal"
                            data-target="#viewProfileModal">
                            <i class="fas fa-user-cog fa-sm fa-fw mr-2 text-gray"></i> Profile
                            <span class="float-right text-muted text-sm"></span>
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" id="changePasswordDropdown" href="#" role="button" data-toggle="modal"
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="registrar_dashboard.php"
                                class="nav-link <?php echo $page == 'registrar_dashboard.php' ? 'active text-white' : '' ?>">
                        ...
                        <li class="nav-item">
                            <a href="registrar_report.php"
                                class="nav-link <?php echo $page == 'registrar_report.php' ? 'active text-white' : '' ?>">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 event-card"
                            data-academic-year-id="<?php echo $row['academic_year_id']; ?>">
                            <div class="card collapsed-card card-outline card-<?php echo $randomColor?>">
                                <div class="card-header">
                                    <h6 class="card-title text-truncate"
                                        style="max-width: 300px; font-size: 10px; display: flex;">
                                        <?php echo $row['event_name']; ?></h6>
                                    <div class="card-tools">
                                        <!-- Display the status badge -->
                                        <span
                                            class="badge badge-<?php echo $status == 'Pending' ? 'warning' : ($status == 'Ongoing' ? 'primary' : 'success'); ?> ml-2"><?php echo $status; ?></span>
                                        <!-- Card tools -->
    ...
    <!-- View Profile Modal -->
    <div class="modal fade" id="viewProfileModal" tabindex="-1" role="dialog" aria-labelledby="viewProfileModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <form id="changePasswordForm">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" id="toggleCurrentPassword"><i class="fa fa-eye-slash"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" id="toggleNewPassword"><i class="fa fa-eye-slash"
                                            aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text" id="toggleConfirmPassword"><i class="fa fa-eye-slash"
                                            aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" id="savePasswordChangesBtn"><i
