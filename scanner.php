...
<head>
    ...
    <!-- Fonts and Icons -->
    <link
        href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500&family=Oswald:wght@200;300;400&display=swap"
        rel="stylesheet">
...
<body>
            ...
            <div class="row">
                <div class="col-md-12 p-3 shadow-lg rounded">
                    ...
                    <div class="border p-3 shadow-sm rounded">
                        ...
                        <h5 class="text-white py-2 text-center"><span class="blink"><small>SHOW QR CODE</small></span>
                        </h5>
                        <div class="row align-items-center mb-2">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-select form-control border border-success" id="timeOption"
                                        aria-label="Select Scan Option">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="input-group input-group-sm my-2">
                                    <input type="text" id="manualInput" class="form-control border border-success"
                                        placeholder="Identification Number">
                                    <span class="input-group-append">
                                        <button type="button" id="manualInputButton" class="btn btn-success btn-flat"
                                            style="min-width: 65px;"><i class="fa-solid fa-check"></i></button>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="attendanceTable"
                                        class="table compact table-bordered responsive table-hover no-wrap"
                                        style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                        ...
                        if (selectedRows.count() > 0) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    selectedRows.every(function(index, tableLoop,
                                        rowLoop) {
                                        var rowNode = this
                                            .node(); // Get the row node
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    ...
                    timer: 500, // Close the alert after .5 seconds
    ...
    function handleAttendance(identificationNumber, scanOption) {
        // Function to format a Date object into 'YYYY-MM-DD HH:MM:SS'
        ...
        // ... your other code before the AJAX call ...

        // 1. Get the current time using JavaScript right before the AJAX call
        const liveScanTime = new Date();
        const formattedTime = formatDateTime(liveScanTime); // Format it for MySQL
        ...
        $.ajax({
            ...
            data: {
                ...
                eventId: <?php echo $eventId; ?>,
                // 2. Use the live, JavaScript-generated time
                    ...
                    if (scanOption === "timeIn") {
                        if (response.trim() === "Attendance added successfully!") {
                            ...
                            Swal.fire({
                                ...
                                showConfirmButton: false // Optional: hide OK button
                            });
                            errorSound.play(); // Play error sound
                        }
