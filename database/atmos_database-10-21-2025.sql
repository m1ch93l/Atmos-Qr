...
--
-- Host: localhost:3306
-- Generation Time: Oct 21, 2025 at 03:03 PM
...
CREATE TABLE `collegestudents` (
  `ID` int NOT NULL,
  `IdentificationNumber` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
(23, '7789678', 'Jetrsdfo', 'Bagassdfala', '7789678', 1, 1, '2025-10-21 14:59:00', '2025-10-21 14:59:00'),
(24, '744789678', 'ddff', 'dddfdf', '744789678', 2, 1, '2025-10-21 14:59:00', '2025-10-21 14:59:00');
...
CREATE TABLE `courses` (
  `id` int NOT NULL,
  `course_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `events` (
  ...
  `event_venue` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `grades` (
  `id` int NOT NULL,
  `grade_name` enum('11','12') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `positions` (
  `ID` int NOT NULL,
  `PositionName` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sections` (
  `id` int NOT NULL,
  `section_name` enum('A','B','C','D') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `strands` (
  `id` int NOT NULL,
  `strand_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
